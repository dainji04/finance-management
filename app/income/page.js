...
export default function IncomePage() {
  const { data, addIncome, updateIncome, deleteIncome, loading, error } =
    useFinance();
  ...
  const submit = async (values) => {
    ...
    try {
      ...
      message.error(
        editingId ? "Không cập nhật được thu nhập" : "Không lưu được thu nhập",
      );
    } finally {
      setSubmitting(false);
    }
  ...
  return (
    <section className="stack">
                ...
                <div className="record-item">
                  <div className="record-item-body">
                    <div className="record-item-header">
                      ...
                      <Text strong className="record-item-amount">
                        {formatCurrency(item.amount)}
                      </Text>
                    </div>
                    <div className="record-item-footer">
                      <span className="muted record-item-note">
      ...
      <Modal
        title={editingId ? "Sửa tiền vào" : "Nhập tiền vào"}
        open={modalOpen}
        onCancel={closeModal}
        footer={null}
        destroyOnClose
        ...
        >
          ...
          >
            <Select>
              ...
              <Option value="Tiền trả nợ">Tiền trả nợ</Option>
